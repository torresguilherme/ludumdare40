...
func _ready():
	...
	rooms.append(load("res://nodes/rooms/room4.tscn"))
	rooms.append(load("res://nodes/rooms/room5.tscn"))
	rooms.append(load("res://nodes/rooms/room6.tscn"))
	generate_rooms()
